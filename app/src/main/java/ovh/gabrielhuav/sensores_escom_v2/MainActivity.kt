...
class MainActivity : AppCompatActivity(), MapView.OnMapTouchListener {
    ...
    // Permisos necesarios para la cámara y Bluetooth (si lo requieres)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bluetoothButton.setOnClickListener {
            // Si también necesitas permisos para Bluetooth, puedes hacerlo aquí
            if (hasPermissions()) {
    ...
    // Verificar si los permisos necesarios ya están otorgados
