...
class Salon2001 : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Asegúrate de tener un layout llamado 'activity_salon2001.xml'
        ...
        try {
            ...
            mapView = MapView(
                context = this,
                // Asegúrate de tener un drawable llamado 'escom_salon2001'
            ...
            mapView.post {
                // Configurar el mapa para el salón 2001
                mapView.setCurrentMap(MapMatrixProvider.MAP_SALON2001, R.drawable.escom_salon2009)

                // Configurar el playerManager
                mapView.playerManager.apply {
                    setCurrentMap(MapMatrixProvider.MAP_SALON2001)
                    localPlayerId = playerName
                    updateLocalPlayerPosition(gameState.playerPosition)
                }

                Log.d(TAG, "Set map to: " + MapMatrixProvider.MAP_SALON2001)

                // Enviar un update inmediato para que otros jugadores sepan dónde estamos
                if (gameState.isConnected) {
                    serverConnectionManager.sendUpdateMessage(playerName, gameState.playerPosition, MapMatrixProvider.MAP_SALON2001)
                }
            }
        } catch (e: Exception) {
        ...
        serverConnectionManager.connectToServer { success ->
            runOnUiThread {
                ...
                if (success) {
                    ...
                    updateBluetoothStatus("Conectado al servidor online - Salón 2001")
                } else {
    ...
    private fun updatePlayerPosition(position: Pair<Int, Int>) {
        runOnUiThread {
            ...
            if (gameState.isConnected) {
                serverConnectionManager.sendUpdateMessage(playerName, position, MapMatrixProvider.MAP_SALON2001)
            }
        }
    }
    ...
    override fun onPositionReceived(device: BluetoothDevice, x: Int, y: Int) {
        runOnUiThread {
            ...
            mapView.updateRemotePlayerPosition(deviceName, Pair(x, y), MapMatrixProvider.MAP_SALON2001)
            mapView.invalidate()
        }
    }
    ...
    override fun onMessageReceived(message: String) {
        runOnUiThread {
            try {
                ...
                val currentMap = MapMatrixProvider.normalizeMapName(MapMatrixProvider.MAP_SALON2001)
    ...
    companion object {
        private const val TAG = "Salon2001"
    }
}