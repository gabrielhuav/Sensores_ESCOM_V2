...
class BuildingNumber4Piso2 : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_building4piso2)

        try {
            // Primero inicializamos el mapView
            mapView = MapView(
                context = this,
                mapResourceId = R.drawable.escom_edificio_4_segunda_planta
            )
            ...
            mapView.post {
                // Configurar el mapa
                val normalizedMap = MapMatrixProvider.normalizeMapName(MapMatrixProvider.MAP_BUILDING4_PISO2)
                mapView.setCurrentMap(normalizedMap, R.drawable.escom_edificio_4_segunda_planta)
    ...
    private fun initializeManagers() {
        bluetoothManager = BluetoothManager.getInstance(this, uiManager.tvBluetoothStatus).apply {
            setCallback(this@BuildingNumber4Piso2)
        }
        ...
        val onlineServerManager = OnlineServerManager.getInstance(this).apply {
            setListener(this@BuildingNumber4Piso2)
        }
    ...
    override fun onMapTransitionRequested(targetMap: String, initialPosition: Pair<Int, Int>) {
        ...
        // 2. Transiciones (Desde Piso 2)
        when (targetMap) {
            MapMatrixProvider.MAP_BUILDING4_PISO1 -> {
                // Bajar al Piso 1
                val intent = Intent(this, BuildingNumber4Piso1::class.java).apply {
                    putExtra("PLAYER_NAME", playerName)
                    putExtra("IS_SERVER", gameState.isServer)
                    putExtra("INITIAL_POSITION", Pair(21, 17)) // Posición al llegar al piso 1
    ...
    private fun enterClassroom(targetMapId: String, returnPosition: Pair<Int, Int>) {
        val intent = Intent(this, StandardClassroomActivity::class.java).apply {
            ...
            putExtra("RETURN_MAP_ID", MapMatrixProvider.MAP_BUILDING4_PISO2) // Estamos en Piso 2
        ...
        if (canChangeMap) {
            runOnUiThread {
                when (targetMapId) {
                    ...
                    MapMatrixProvider.MAP_SALON4201 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 4201", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON4202 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 4202", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON4203 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 4203", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON4204 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 4204", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON4205 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 4205", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON4206 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 4206", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_BUILDING4_PISO1 -> {
                        Toast.makeText(this, "Presiona A para entrar al edificio 4 primera planta", Toast.LENGTH_SHORT).show()
                    }
                    else -> {
