...
class Estacionamiento : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            mapView = MapView(
                context = this,
                mapResourceId = R.drawable.estacionamiento
            )
            ...
            mapView.post {
                ...
                mapView.setCurrentMap(normalizedMap, R.drawable.estacionamiento)
                ...
                Log.d("estacionamiento", "Set map to: $normalizedMap")
            }
        } catch (e: Exception) {
    ...
    private fun initializeManagers() {
        bluetoothManager = BluetoothManager.getInstance(this, uiManager.tvBluetoothStatus).apply {
            setCallback(this@Estacionamiento)
        }
        ...
        val onlineServerManager = OnlineServerManager.getInstance(this).apply {
            setListener(this@Estacionamiento)
        }
            ...
            runOnUiThread {
                when (targetMapId) {
                    ...
                    MapMatrixProvider.MAP_ESTACIONAMIENTO -> {
                        Toast.makeText(this, "Presiona A para entrar al estacionamient", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON2010 -> {
    ...
    /*
    private fun checkPositionForMapChange(position: Pair<Int, Int>) {
        canChangeMap = position.first == 11 && position.second == 4
        if (canChangeMap) {
            runOnUiThread {
    ...
    private fun updatePlayerPosition(position: Pair<Int, Int>) {
        runOnUiThread {
            try {
                ...
                if (gameState.isConnected) {
                    serverConnectionManager.sendUpdateMessage(playerName, position, "estacionamiento")
                }
