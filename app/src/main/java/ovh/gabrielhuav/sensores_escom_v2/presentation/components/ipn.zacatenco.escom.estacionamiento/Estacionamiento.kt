...
class Estacionamiento : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            mapView = MapView(
                context = this,
                mapResourceId = R.drawable.escom_estacionamiento // Usa la imagen del estacionamiento
            )
        ...
        serverConnectionManager.connectToServer { success ->
            runOnUiThread {
                ...
                if (success) {
                    ...
                    updateBluetoothStatus("Conectado al servidor online - Estacionamiento")
                } else {
    ...
    private fun initializeViews() {
        ...
        tvBluetoothStatus.text = "Estacionamiento - Conectando..."
    }
                    ...
                    "positions" -> {
                        ...
                        players.keys().forEach { playerId ->
                            if (playerId != playerName) {
                                ...
                                if (map == MapMatrixProvider.MAP_ESTACIONAMIENTO) {
