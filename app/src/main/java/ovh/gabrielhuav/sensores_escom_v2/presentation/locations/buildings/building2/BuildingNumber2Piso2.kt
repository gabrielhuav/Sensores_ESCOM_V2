...
class BuildingNumber2Piso2 : AppCompatActivity(),
    ...
    private fun enterClassroom(targetMapId: String, returnPosition: Pair<Int, Int>) {
        val intent = Intent(this, StandardClassroomActivity::class.java).apply {
            ...
            putExtra("RETURN_MAP_ID", MapMatrixProvider.MAP_BUILDING2_PISO2) // Estamos en Piso 2
        ...
        if (canChangeMap) {
            runOnUiThread {
                when (targetMapId) {
                    ...
                    MapMatrixProvider.MAP_SALON2201 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 2201", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON2202 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 2202", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON2203 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 2203", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON2204 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 2204", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON2205 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 2205", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_SALON2206 -> {
                        Toast.makeText(this, "Presiona A para entrar al salón 2206", Toast.LENGTH_SHORT).show()
                    }
                    MapMatrixProvider.MAP_BUILDING2_PISO1 -> {
