...
class PalapasIA : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            mapView = MapView(
                context = this,
                mapResourceId = R.drawable.escom_palapas_ia // Usa la imagen de Palapas de IA
            )
    ...
    private fun showZombieGameIntroDialog() {
        ...
        AlertDialog.Builder(this)
            .setTitle("¡Bienvenido a Palapas de IA!")
            .setMessage("¡Cuidado! Hay zombies hambrientos. " +
    ...
    private fun stopZombieGame() {
        if (zombieGameActive) {
            ...
            // Actualizar UI
            runOnUiThread {
                tvBluetoothStatus.text = "Conectado al servidor online - Palapas IA"
                btnB1.text = "B1"
    ...
    private fun updateGameStatus() {
        if (!zombieGameActive) {
            updateBluetoothStatus("PALAPAS IA ESCOM - Conectado al servidor")
            return
        }
